  ...
  >
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
      ...
      >
        <NuxtLink
          to="/guides"
          class="hover:text-mystic-blue transition-colors duration-200 flex items-center gap-1"
        >
          <svg
            class="w-4 h-4"
            fill="none"
        ...
        <NuxtLink
          to="/resources"
          class="hover:text-instinct-yellow transition-colors duration-200 flex items-center gap-1"
        >
          <svg
            class="w-4 h-4"
            fill="none"
    ...
    >
      ...
      >
        ...
        >
          <NuxtLink
            to="/guides"
            class="hover:text-mystic-blue transition-colors duration-200 flex items-center gap-2 py-2 border-b border-slate-200 dark:border-brand-surface"
            @click="closeMenu"
          >
            <svg
              class="w-4 h-4"
          ...
          <NuxtLink
            to="/resources"
            class="hover:text-instinct-yellow transition-colors duration-200 flex items-center gap-2 py-2 border-b border-slate-200 dark:border-brand-surface"
            @click="closeMenu"
          >
            <svg
              class="w-4 h-4"
          ...
          <NuxtLink
            to="/submit-guide"
            class="hover:text-green-500 transition-colors duration-200 flex items-center gap-2 py-2 border-b border-slate-200 dark:border-brand-surface"
            @click="closeMenu"
          >
            <svg
              class="w-4 h-4"
