  ...
  <main class="max-w-7xl mx-auto px-6 py-12 md:py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a
        ...
        class="group block bg-white dark:bg-brand-surface/20 border border-slate-200 dark:border-brand-surface rounded-2xl p-6 hover:bg-white dark:hover:bg-brand-surface/30 hover:border-mystic-blue/50 transition-all duration-300"
      >
