    ...
    <section class="max-w-7xl mx-auto px-6 py-20 space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <NuxtLink
          ...
          :key="guide._id"
          :to="`/guides/${guide.slug}`"
          class="group block p-6 rounded-3xl bg-white dark:bg-brand-surface/10 border border-slate-200 dark:border-brand-surface hover:border-mystic-blue/50 hover:bg-white dark:hover:bg-brand-surface/20 transition-all duration-300 cursor-pointer"
        >
