  ...
  <main class="max-w-7xl mx-auto px-6 py-16">
    ...
    >
      <NuxtLink
        ...
        class="flex flex-col p-6 rounded-3xl bg-white dark:bg-brand-surface/20 border border-slate-200 dark:border-brand-surface hover:bg-white dark:hover:bg-brand-surface/30 hover:border-mystic-blue/30 transition-all duration-300 cursor-pointer group"
      >
        <h2
