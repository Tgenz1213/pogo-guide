/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.test.jsonc` (hash: edbbbf893099f1efbfb39bc96e5ed42f)
// Runtime types generated with workerd@1.20260521.1 2026-05-25 nodejs_compat
interface __BaseEnv_Env {
  POGO_RATE_LIMIT: KVNamespace;
  DB: D1Database;
  ASSETS: Fetcher;
  NUXT_PUBLIC_TURNSTILE_SITE_KEY: string;
  NUXT_TURNSTILE_SECRET_KEY: string;
  NUXT_SESSION_PASSWORD: string;
  NUXT_HASH_PEPPER: string;
  NUXT_OAUTH_DISCORD_CLIENT_ID: string;
  NUXT_OAUTH_DISCORD_CLIENT_SECRET: string;
...
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./.cloudflare/server/index");
  }
